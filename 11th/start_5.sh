...
AP_HOME=/mnt/d/workspace/ardupilot
...
sleep 1
screen -S mav2 -dm $AP_HOME/Tools/autotest/sim_vehicle.py -v ArduCopter -I1 --custom-location=35.80005627,139.0842228,0,0 --map --console --sysid 2
sleep 1
